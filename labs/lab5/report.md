...
subtitle: "Модель хищник-жертва - вариант 69"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.28x(t) + 0.045y(t)x(t)
	\\   
...
при следующих начальных условиях: $x_0=10, y_0=31$
...
Стационарное состояние $x_0=\frac{a}{b}=6.222, y_0=\frac{c}{d}=10.857$
