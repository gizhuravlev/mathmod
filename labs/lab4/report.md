...
subtitle: "Модель гармонических колебаний - вариант 69"
...
силы $\ddot{x}+4.4\dot{x}+0.4x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+4\dot{x}+4x=0.4\sin{4t}$

На итнтервале $t \in [ 0;64 ]$, шаг 0.05, $x_0=0.4, y_0=0.4$
